...
class TkinterApp(tk.Tk):
    ...
    def __init__(self):
        ...
        app_name = tk.Label(self.brand_frame,
                            text='Homehub',
                            bg=sidebar_color,
                            font=("", 15, "bold")
                            )
        app_name.place(x=55, y=27, anchor="w")
        ...
        att_submenu = SidebarSubMenu(self.submenu_frame,
                                     sub_menu_heading='Select what you want to display',
                                     sub_menu_options=["Bulbs",
                                                       "Doorbell",
                                                       ]
                                     )
        att_submenu.options["Bulbs"].config(
            command=lambda: self.show_frame(Frame1)
        )
        att_submenu.options["Doorbell"].config(
...
class Frame1(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text='Kasa Bulbs', font=("Arial", 15))
        label.pack()
...
class Frame2(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text='Ring Doorbell', font=("Arial", 15))
        label.pack()
